 ...
 function clearAll() {
    const memeConteiner = document.querySelector('.meme-content');
    const jokeConteiner = document.querySelector('.joke-content');
    const quoteConteiner = document.querySelector('.quote-content');
    const riddleConteiner = document.querySelector('.riddle-content');

    memeConteiner.innerHTML = '';
    jokeConteiner.innerHTML = '';
    quoteConteiner.innerHTML = '';
    riddleConteiner.innerHTML = '';
 ...
 function showMeme() {
   ...
   let container = document.querySelector('.meme-content');
 ...
 function showJoke() {
   ...
   let container = document.querySelector('.joke-content');
 ...
 function showRiddle() {
   ...
   const conteiner =  document.querySelector('.riddle-content');
   clearAll();
   conteiner.appendChild(questionElem);
   conteiner.appendChild(answerElem);
 ...
 function revealAnswers() {
    const riddleConteiner = document.querySelector('.riddle-content');
    const riddle = riddleConteiner.querySelector('p');
    ...
    if(riddle && answer.hidden){
        ...
        alert('There is already an answer revealed.');
    }else{
